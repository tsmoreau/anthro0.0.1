    ...
    <>
      <div className="h-full w-full">
        ...
        >
          ...
          />
          <div className="w-64 z-40 fixed z-40 top-0 bg-black shadow h-full flex-col justify-between lg:hidden pb-4 transition duration-150 ease-in-out">
                  ...
                  <div className="mt-6 flex w-full items-center justify-between">
                    <div className="flex items-center justify-between w-full">
                      ...
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="icon icon-tabler icon-tabler-x -translate-y-2 translate-x-2"
                          width={24}
                          height={24}
                          viewBox="0 0 24 24"
                          strokeWidth="1.5"
            ...
            {isConnected ? (
              <div className="text-white">
                <Popover className="relative">
                  ...
                  <Popover.Panel className="z-40 font-mono  border w-48 absolute -translate-x-16 translate-y-4 z-10 bg-black">
                    <div className="flex flex-col">
                      <a
                        className="w-full py-4 hover:bg-yggpurple-300 "
                        href="/"
